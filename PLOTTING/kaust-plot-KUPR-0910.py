...
sheet_url = "https://docs.google.com/spreadsheets/d/1PzKvxN1ARlnQVYnCtM05Cs15VzTi76UHMyJmk6CQrNs/edit#gid=645403153"
...
# CHANGE VALUES IN lines 13, 55, 135-143, 184
...
# correct sigfigs for parameters
...
values = [0,1] # can also do values = [2,3] for DOE-KUPRION-003
#for z in range(0, len(workdf.index)-1):
    #if (workdf.iloc[z, 11] == workdf.iloc[z+1, 11]):
    #    values.append(z+1)
    #    print(z)
    #else:
...
fig.update_layout(height=1100, width=1200,
                  title_text="Scatterplots of electrical parameters versus hours in Temperature Cycling")
