...
#        sketches.add(rootComp.xYConstructionPlane)
        ...
        point0 = adsk.core.Point3D.create(-2, -8.7, 0)
        point1 = adsk.core.Point3D.create(-2, 8.7, 0)
        point2 = adsk.core.Point3D.create(2, 8.7, 0)
        point3 = adsk.core.Point3D.create(2, -8.7, 0)
